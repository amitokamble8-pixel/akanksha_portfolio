...
const ConnectPanel = () => (
  <Reveal>
    <div className="connect">
      ...
      <p>
        I'd love to hear from you. Feel free to reach out—I'm always open to meaningful conversations, new opportunities, and exciting collaborations.
      </p>
      <div className="cta-row">
...
export function Home() {
  usePageMeta(
    `${SITE} | Building intelligent solutions • Exploring complex questions • Leading with purpose`,
    ""
  );
  return (
    <>
      ...
      <section className="section">
        ...
        <MoreLink to="/awards">Every Awards & Recognitions</MoreLink>
      </section>
      ...
      <section className="section">
        ...
        <MoreLink to="/work">More about Work Experience</MoreLink>
      </section>

      <section className="section">
        <SectionHead title="Featured Projects" eyebrow="Research · Innovation" />
        <div className="grid-2">
          {PROJECTS.filter((p) => p.featured).map((p, i) => (
            <Reveal key={p.name} delay={i * 90}><ProjectCard p={p} /></Reveal>
          ))}
        </div>
        <MoreLink to="/projects">More about Featured Projects</MoreLink>
      </section>
      ...
      <section className="section">
        <SectionHead title="Areas of Interest" eyebrow="What I'm Interested In" />
        <div className="row-list">
          {ARTICLES.map((a, i) => (
      ...
      <section className="section">
        <SectionHead title="Leadership & Impact" eyebrow="Leadership · Communication · Service" />
        <Reveal>
        ...
        <MoreLink to="/volunteering">More about Leadership & Impact</MoreLink>
      </section>
...
export function About() {
  ...
  return (
    <section className="section">
      ...
      <SubHead title="Education" eyebrow="" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Featured Projects" eyebrow="Research · Innovation" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Publications() {
  ...
  return (
    <section className="section">
      <PageHead title="Areas of Interest" eyebrow="What I'm Interested In" />
      <div className="row-list">
        {ARTICLES.map((a, i) => (
          <Reveal key={a.title} delay={i * 60}><ArticleRow a={a} /></Reveal>
        ))}
...
export function Volunteering() {
  usePageMeta(`Leadership & Impact | ${SITE}`, "Founding a machine learning club, teaching summer band, and community volunteering.");
  return (
    <section className="section">
      <PageHead title="Leadership & Impact" eyebrow="Leadership · Communication · Service" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
...
export function Sports() {
  usePageMeta(`Creative Expression | ${SITE}`, "Marching band, saxophone ensemble, concert band, hackathons, and game jams.");
  return (
    <section className="section">
      <PageHead title="Creative Expression" eyebrow="Extra-curricular Activities" />
